...
# TODO(dkorolev): `jq`? What else?
RUN apt-get install -y git zsh vim curl screen sudo npm wget build-essential cmake python3 python3-dev golang nodejs default-jdk
...
RUN git clone https://github.com/dkorolev/dotfiles
